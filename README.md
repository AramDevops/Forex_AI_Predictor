Open Source Strong trading tool that use machine learning to predict future values of currencies conventions supporting ['USD', 'EUR', 'BRL', 'CHF', 'GBP', 'ARS', 'CAD', 'CNY', 'JPY']
